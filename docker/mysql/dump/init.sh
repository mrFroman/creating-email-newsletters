...
mysql --user=root --password=DfyLthCfhyjvth1 --database=template_bs --force < /tmp/dump/data_bases_main_citymailsend.sql
mysql --user=root --password=DfyLthCfhyjvth1 --database=template_bs --force < /tmp/dump/data_bases_main_datemailsend.sql
mysql --user=root --password=DfyLthCfhyjvth1 --database=template_bs --force < /tmp/dump/data_bases_main_mainindex.sql
